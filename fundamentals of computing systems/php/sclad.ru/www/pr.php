...
// Если это результат обработки формы данного файла
{
 ...
 $zx=$_POST['NewCol'];
 $sqlNewTov="INSERT INTO Nomenclatura SET tovar='"
 .$_POST['NewTovar']."',idScl=".$lineScl[0].",col=".$zx;
 mysql_query($sqlNewTov) or die(mysql_error());
}
$sql="SELECT tovar,idScl,col FROM Nomenclatura ORDER BY tovar";
$data=mysql_query($sql);
?>
<font style="font-size:16pt">
Сейчас на складе  :</font>
<table border=1>
<?php
...
<font size="+2"> Ввод новых товаров</font>
...
Число  :<input type='text' name='NewCol' value=''><br>
<br><br>
